...
const documents = {
    ...
    "\n    query searchOnRestaurant($page: Int!, $limit: Int!, $predicate: String, $restaurantId: String, $filtering: String){\n        search(page: $page, limit: $limit, predicate: $predicate, restaurantId: $restaurantId, filtering: $filtering){\n            products{\n                id\n                picture\n                title\n                price\n            }\n            pageCount\n        }\n    }\n": types.SearchOnRestaurantDocument,
};
